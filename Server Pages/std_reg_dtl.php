...
if(isset($_POST['filter_class']))
{
  ...
  $sql_std_dtl="SELECT * FROM std_reg INNER JOIN class_dtl ON std_reg.std_class_id = class_dtl.cid WHERE std_class_id='$std_class_id' AND std_reg.status='1';";
  $qry_std_dtl=mysqli_query($conn,$sql_std_dtl) OR die('error');
  
}
else
{
  $sql_std_dtl="SELECT * FROM std_reg INNER JOIN class_dtl ON std_reg.std_class_id = class_dtl.cid WHERE std_reg.status='1';";
$qry_std_dtl=mysqli_query($conn,$sql_std_dtl) OR die('error');
}
?>
                    ...
                    <table class="table table-bordered" id="table">
                      ...
                      <tbody>
                        ...
                        <tr <?php if($row_std_dtl['card_status']=='0'){ echo 'style="background-color:red;"'; } ?> class="<?php echo $row_std_dtl['id']; ?>">
                          ...
                          <td><?php echo $row_std_dtl['std_address']; ?></td>
                          <td>
                         ...
                         ?>
                         <a  href="std_edit.php?std_rid=<?php echo $row_std_dtl['id'] ?>&l=1" class="btn  btn-sm " style="background-color: #000099;color:white;border:1px solid black;"><i class="mdi mdi-lead-pencil Icon-lg " title="Edit"></i></a>
